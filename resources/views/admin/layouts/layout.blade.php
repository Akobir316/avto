    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" target="_blank" class="brand-link">
            <img src="{{ asset('assets/admin/img/AdminLTELogo.png') }}"
                 ...
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Saytga qaytish</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img style="height: 35px; width: 35px" src="{{ asset('assets/admin/img/user_logo.jpeg') }}" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
